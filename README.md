...
Auto Install:  
1. Copy the "AppData" folder to the root of your user folder "C:\Users\YOUR_USERNAME\"  
...
3. Extract the folder and copy to "YOUR_USER_FOLDER\AppData\Roaming\itch\broth\butler\versions\VERSION_NUMBER\" (You'll need to create the version number folder, eg 15.21.0).  
4. Click "Retry" in the setup, it should fail again.  
5. Copy the "itch-setup.exe" file you downloaded to "YOUR_USER_FOLDER\AppData\Roaming\itch\broth\itch-setup\versions\VERSION_NUMBER\" (You'll need to create the version number folder, eg 1.26.0).  
